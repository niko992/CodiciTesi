% OP_LAM_THETA_PHI_TP: assemble the matrix A = [a(i,j)], a(i,j) = 1/2 (sigma (u_j), epsilon (v_i)), exploiting the tensor product structure.
%
...
function varargout = op_lam_theta_I_phi_I_tp (space1, space2, msh, lambda, ndof_p)
  ...
  for iel = 1:msh.nel_dir(1)
    ...
    A = A + op_lam_theta_I_phi_I (sp1_col, sp2_col, msh_col, lambda(x{:}));
  end
