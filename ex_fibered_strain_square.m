...
fx = @(x, y) -((-problem_data.mu_lame(x,y)-problem_data.Ef*(1+sqrt(3))/16).*sin(x).*cos(y)+...
    (problem_data.mu_lame(x,y)/2+problem_data.lambda_lame(x,y)-problem_data.Ef*(1+sqrt(3))/16).*cos(x).*sin(y));
fy = @(x, y) -((problem_data.mu_lame(x,y)/2+problem_data.lambda_lame(x,y)-problem_data.Ef*(1+sqrt(3))/16).*sin(x).*cos(y)-...
    problem_data.Ef*(1+sqrt(3))/16*cos(x).*sin(y)-problem_data.mu_lame(x,y).*sin(x-y));
...
graduex21 = @(x,y) -sin(x - y);
graduex22 = @(x,y) sin(x - y);
